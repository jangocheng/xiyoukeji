...
<script>
    export default {
        ...
        data(){
            return{
                youShiList:[{
                    imgUrl:'../../../static/images/icons/advantage1@2x.png',
                    title:'用完即走',
                    con:'不用安装，即开即用，用完就走。省流量，省安装时间，不占用桌面'
                },
                {
                    imgUrl:'../../../static/images/icons/advantage2@2x.png',
                    title:'体验优良',
                    con:'体验上虽然没法完全媲美原生APP，但综合考虑还是更优'
                },
                {
                    imgUrl:'../../../static/images/icons/advantage3@2x.png',
                    title:'降低成本',
                    con:'对于小程序拥有者来说，开发成本更低，他们可以更多财力，人力，精力放在如何运营好产品，做好内容本身'
                },
                {
                    imgUrl:'../../../static/images/icons/advantage4@2x.png',
                    title:'更易用',
                    con:'对于用户来说，相较于各种APP，微信小程序UI和操作流程会更统一。这也会降低用户的使用难度'
                },
                {
                    imgUrl:'../../../static/images/icons/advantage5@2x.png',
                    title:'易推广',
                    con:'对于小程序拥有者来说，相较于原生APP，推广更容易更简单，更省成本。'
                }, {
                    imgUrl:'../../../static/images/icons/advantage6@2x.png',
                    title:'连接一切',
                    con:'微信小程序具有线下连接一切的使命，2014 年 11 月，马化腾在「世界互联网大会」上提出腾讯要「连接一切」，要成为互联网连接器'
                }]
            }
        }
    }
...
.foot-list::after,.foot-list ul::after{
    clear: both;
    display: block;
    content: '';
}
.foot-list ul:nth-of-type(2)>li{
    margin-left: 5%;
}
.foot-list ul img{
     float: left;
...
.youshi-con .list-right p{
    color: #666666;
    font-size: 12px;
    margin-top: 10px;
}
.youshi-con .list-right h4{
    color: #666666;
    font-size: 14px;
}
.youshi-con .list-right{
    width: 85%;
    float:right;
    /* vertical-align: middle; */
}
.youshi-con .list-left img{
    width: 50%;
    /* line-height: 100px; */
    
    /* vertical-align: middle; */
}
.youshi-con .list-left{  
    float: left;
    width: 15%;
     line-height: 60px;
}
